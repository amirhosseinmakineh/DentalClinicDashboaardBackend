...
public partial class AddConsultantReservationRewards : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.AddColumn<DateTime>(name: "ConsultantRewardEligibleAt", table: "Reservations", type: "datetime2", nullable: true);
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropColumn(name: "ConsultantRewardEligibleAt", table: "Reservations");
