...
{
    public class SellerConsultantLeadAssignmentBackgroundService : BackgroundService
    {

        private readonly IServiceScopeFactory scopeFactory;
        private readonly ILogger<SellerConsultantLeadAssignmentBackgroundService> logger;

        public SellerConsultantLeadAssignmentBackgroundService(
            IServiceScopeFactory scopeFactory,
            ILogger<SellerConsultantLeadAssignmentBackgroundService> logger)
        {
