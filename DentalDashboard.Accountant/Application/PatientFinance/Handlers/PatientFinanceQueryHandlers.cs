...
using DentalDashboard.Accountant.Application.Contracts.PatientFinance
    .Queries;
using DentalDashboard.Domain.Models;
using DentalDashboard.Accountant.Domain.PatientFinance.Enums;
using DentalDashboard.Accountant.Domain.PatientFinance.IRepositories;
using Microsoft.EntityFrameworkCore;

namespace DentalDashboard.Accountant.Application.PatientFinance.Handlers;
