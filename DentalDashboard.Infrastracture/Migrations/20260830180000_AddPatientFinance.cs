...
public partial class AddPatientFinance : Migration
{
 ...
 {
  m.Sql("""
CREATE TABLE [PatientFinancialCases] ([Id] uniqueidentifier NOT NULL CONSTRAINT [PK_PatientFinancialCases] PRIMARY KEY,[PatientId] bigint NOT NULL,[Service] int NOT NULL,[TotalAmount] decimal(18,2) NOT NULL,[AgreementType] int NOT NULL,[Status] int NOT NULL,[CreatedByUserId] uniqueidentifier NOT NULL,[CreatedAt] datetime2 NOT NULL,[UpdatedAt] datetime2 NULL,[IsDeleted] bit NOT NULL,[DeletedAt] datetime2 NULL,CONSTRAINT [FK_PatientFinancialCases_PatientProfiles_PatientId] FOREIGN KEY ([PatientId]) REFERENCES [PatientProfiles]([Id]),CONSTRAINT [FK_PatientFinancialCases_Users_CreatedByUserId] FOREIGN KEY ([CreatedByUserId]) REFERENCES [Users]([Id]));
