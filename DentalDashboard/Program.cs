...
using DentalDashboard.ApplicationService.Handlers.QueryHandlers.Reservation;
...
builder.Services.AddTransient<ICommandHandler<CreateReservationCommand, CreateReservationResponse>, CreateReservationCommandHandler>();
...
builder.Services.AddTransient<IQueryHandler<GetConsultantReservationsQuery, PaginatedResult<ReservationItemResponse>>, GetConsultantReservationsQueryHandler>();
