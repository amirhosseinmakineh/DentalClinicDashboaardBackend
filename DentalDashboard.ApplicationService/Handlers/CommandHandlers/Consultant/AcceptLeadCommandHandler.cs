...
public class AcceptLeadCommandHandler : ICommandHandler<AcceptLeadCommand, AcceptLeadResponse>
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!broadcastTestFilter.CanAccessLead(consultant.UserId, assignment))
            return Result<AcceptLeadResponse>.Failure("این لید تست فقط برای مشاوران تست در دسترس است");
