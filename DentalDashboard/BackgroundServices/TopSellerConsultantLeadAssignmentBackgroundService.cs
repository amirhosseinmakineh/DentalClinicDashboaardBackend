...
{
    public class TopSellerConsultantLeadAssignmentBackgroundService : BackgroundService
    {

        private readonly IServiceScopeFactory scopeFactory;
        private readonly ILogger<TopSellerConsultantLeadAssignmentBackgroundService> logger;

        public TopSellerConsultantLeadAssignmentBackgroundService(
            IServiceScopeFactory scopeFactory,
            ILogger<TopSellerConsultantLeadAssignmentBackgroundService> logger)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                await RunStepAsync("AssignRealTimeLeads", () => leadAssignmentService.AssignLeadToTopSellertConsultant(), stoppingToken);
