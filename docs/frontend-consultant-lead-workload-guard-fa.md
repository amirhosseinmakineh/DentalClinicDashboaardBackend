...
1. مشاور حداقل یک شماره دارد که هنوز تماس آن شروع نشده (`callInitiatedAt` خالی است) و گزارشی برای آن ثبت نشده است.
...
```json
{
  "profileId": 42,
  "canGoOnline": false,
  "onlineStatusBlockReason": "شما 1 شماره بدون تماس و گزارش و 11 مورد در حالت پیگیری دارید...",
  "uncalledWithoutReportCount": 1,
  "followUpCount": 11,
  "maximumAllowedFollowUps": 10,
  "isNewLeadBlocked": true,
  "shouldShowWorkloadNotification": true,
  "workloadNotificationMessage": "شما 1 شماره بدون تماس و گزارش و 11 مورد در حالت پیگیری دارید..."
}
```
...
- شمارنده‌های `uncalledWithoutReportCount` و `followUpCount` را در notification یا کارت هشدار نمایش دهید تا کاربر بداند چه مواردی را باید تعیین تکلیف کند.
