...
## گزارش روزانه بک‌گراند

سرویس بک‌گراند هر روز ساعت 22:00 گزارش روز قبل را تولید و در مسیر زیر روی سرور ذخیره می‌کند:

`Reports/LeadCallReports/lead-call-reports-yyyyMMdd.csv`
